 ...
 *  - servicio@illuminations.com.pa (lider_servicios) — puede crear tickets, adjuntar.
 *  - carlos@illuminations.com.pa   (tecnico_servicios) — NO puede crear tickets ni adjuntar.
 */
